...
const Register = () => {
  ...
  // State tambahan untuk flow "Cek Email"
  ...
  // Fungsi penangan Tombol Cek Email awal
  const handleCheckEmail = async () => {
    if (!form.email) {
      Swal.fire({
        icon: "warning",
        title: "Email Kosong",
        text: "Silakan masukkan alamat email terlebih dahulu.",
      });
      return;
    }
    ...
    try {
      ...
      // Menembak ke router auth backend (/api/auth/check-email)
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        Swal.fire({
          ...
          text: "Data ditemukan. Silakan lanjutkan pengisian formulir di bawah.",
          timer: 2500,
      ...
      const errorMsg =
        ...
        "Email Anda tidak terdaftar di database PLN MOBILE.";
      Swal.fire({
        icon: "error",
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="form-group grid-span-full">
                ...
                <div className="email-verify-container">
                  <input
                    ...
                    className="form-control email-verify-input"
                    disabled={isEmailVerified}
                  />
                  <button
                    type="button"
                    onClick={handleCheckEmail}
                    className={`btn email-verify-btn ${isEmailVerified ? "verified" : ""}`}
                    disabled={checkingEmail || isEmailVerified}
                  >
                    {checkingEmail
                      ? "Memeriksa..."
                      : isEmailVerified
              ...
              {/* HANYA MUNCUL JIKA EMAIL SUDAH TERVERIFIKASI */}
              {isEmailVerified && (
                <>
          ...
          {/* pengecekan email kalau berhasil/terverifikasi bisa mengisi formulir  */}
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group grid-span-full">
                    ...
                    <div className="info-note">
                      * Harap isi bagian ini jika Anda memiliki kondisi
                      kesehatan khusus.
                    </div>
                  </div>
                </div>
                    ...
                    <div className="grid-span-full pickup-info-box">
                      ...
                      <div className="form-group" style={{ marginTop: "1rem" }}>
                        ...
                        >
                          ...
                          <option value="pickup_bsd_day1( Foresta BSD - Hari 1 (10:00 - 18:00 WIB)">
                            Foresta BSD - Hari 1 (10:00 - 18:00 WIB)
                          </option>
                          <option value="pickup_bsd_day2 ( Foresta BSD - Hari 2 (10:00 - 18:00 WIB)">
                  ...
                  >
                    <label className="checkbox-label">
                      ...
                      <span>
                        ...
                        asuransi rekanan penyelenggara untuk durasi PLN Energy
                        Run 2026. <span className="req-star">*</span>
                      </span>
                    </label>
                  </div>
                </div>
